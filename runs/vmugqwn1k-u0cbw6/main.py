...
def recuperar_dados():
    ...
    dados = {}
    for linha in linhas:
        # Utilizando um formato de arquivo binário para evitar problemas de parsing
        with open('aof.log', 'rb') as f_bin:
            dados_bin = pickle.load(f_bin)
            dados.update(dados_bin)
    return dados
