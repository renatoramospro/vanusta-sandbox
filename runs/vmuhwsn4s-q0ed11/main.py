...
def handle_client(client_socket, address):
    ...
    try:
        while True:
            ...
            # Decodificação básica de URI para segurança de caminho
            ...
            # Resolução segura de caminho para prevenir Path Traversal
            requested_path = os.path.abspath(os.path.join(STATIC_DIR, decoded_path.lstrip("/")))
            
            # Validação via commonpath para garantir confinamento em STATIC_DIR
            try:
            ...
            if not is_safe or not os.path.exists(requested_path) or os.path.isdir(requested_path):
                ...
                # Serve 200 OK com arquivo estático
            ...
            # Verifica cabeçalho Connection para persistência
